...
mod tests {
    ...
    #[test]
    fn looks_like_days_plain_number() {
        assert!(looks_like_days("7"));
    }

    #[test]
    fn looks_like_days_range() {
        assert!(looks_like_days("3-7"));
    }

    #[test]
    fn looks_like_days_city_name() {
        assert!(!looks_like_days("Berlin"));
    }

    #[test]
    fn looks_like_days_float() {
        assert!(!looks_like_days("3.14"));
    }
